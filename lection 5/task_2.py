...
def repeats(our_str):
    ...
    и добавляет после каждого символа номер вхождения данного символа в строку через '_'
    пример вхождение 'letter' --> l_1e_1t_1t_2e_2_r_1
    :param our_str: исходная строка
    :return: новая строка с вставленной нумерацией вхождений символов
    """
    ...
    for characters in list_characters_our_str:
        ...
        new_str = f"{new_str}{characters}_{letters_dict[characters]}"
    return new_str
