...
def letter_stat_option_2(our_str):
    """
    Функция подсчитывает количество вхождений символов в переданную строку
    используется импорт модуля Counter
    :param our_str: строка
    :return: словарь типа {[символ]:[количество вхождений]}
    """
    list_characters_our_str = list(our_str)
    num_characters = Counter(list_characters_our_str)
    letters_dict = dict(num_characters)
    return letters_dict
...
def letter_stat(our_str):
    """
    Функция подсчитывает количество вхождений символов в переданную строку
    не используя импорт сторонних модулей
    :param our_str: строка
    :return: словарь типа {символ: количество вхождений}
    """
    list_characters_our_str = list(our_str)
