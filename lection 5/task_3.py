...
def everything_for_your_cat(cats_data):
    """
    Преобразует Список кортежей котов типа [(Кличка котика, Возраст котика, Имя покупателя, Фамилия покупателя)]
    в строку типа:
    "Имя покупателя Фамилия покупателя: Кличка котика, Возраст котика; Кличка котика, Возраст котика ...\n..."
    :param cats_data: Список кортежей котов типа [(Кличка котика, Возраст котика, Имя покупателя, Фамилия покупателя)]
    :return: строка типа:
             "Имя Фамилия: Кличка, Возраст; Кличка, Возраст ...\n
              Имя Фамилия: Кличка, Возраст; Кличка, Возраст ...\n
              ..."
    """
    dict_owners_cats = {}
    for j in cats_data:
        name_owners = " ".join(j[2:])
        if name_owners not in dict_owners_cats:
            dict_owners_cats.update({name_owners: f"{j[0]}, {j[1]}"})
        else:
            dict_owners_cats[name_owners] = f"{dict_owners_cats[name_owners]}; {j[0]}, {j[1]}"
    our_str = str()
    for owners, cats in dict_owners_cats.items():
        our_str = our_str + f"{owners}: {cats}\n"
    return our_str
